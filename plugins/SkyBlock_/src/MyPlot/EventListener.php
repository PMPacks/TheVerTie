    ...
    public function onPlayerMove(PlayerMoveEvent $event) {
        ...
        if ($plot !== null and $plot !== $this->plugin->getPlotByPosition($event->getFrom())) {
            ...
            if ($plot->owner != "") {
				...
				$event->getPlayer()->addTitle("§l§dSky§eBlock", "§a§lBạn Đã Đến Đảo Của§e ".$owner);
				//$this->plugin->getServer()->broadcastMessage("§l§b[§aSKYBLOCK§b]§e ".$event->getPlayer()->getName()."§6 vừa đi sang đảo của §e ".$owner);
            } else {
