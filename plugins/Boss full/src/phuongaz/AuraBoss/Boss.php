...
Class Boss extends PluginBase implements Listener
{
	...
	public function spawnBoss($id, $cast = false){
        ...
        //});
		if($cast){
			Server::getInstance()->broadcastMessage("§l§6[§aWarp Boss§6]§e↣ Boss ".$ent->getNameTag()."§l§a Đã Được Triệu Hồi Tại §e/warpboss Hãy Mau Chóng Đến Tiêu Diệt Ngay Nào!");
		}
	...
	public function spawnAllBoss(){
		...
		Server::getInstance()->broadcastMessage(TF::BOLD. TF::BLUE. "§l§6[§aWarpBoss§6]§e↣§aToàn Bộ Boss Đã Được Triệu Hồi Mau Đến Tiêu Diệt Ngay!");
	}
